...
Busca de Log's por Código do Item
</div> 
  
<div class="form-group">
            <input type="text" class="form-control" name="codi1" id="codi1" placeholder="Código do Item(Baixo)	" required/>
</div>

<div class="form-group">
            <input type="text" class="form-control" name="codi2" id="codi2" placeholder="Código do Item(Cima)" required/>
</div>
...
<br><br>
                    ...
                    </strong>1 Passo - Digite o cod cima e cod baixo do item que você deseja verificar os logs.<BR>
