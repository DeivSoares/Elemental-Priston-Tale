...
<?
 /*----------------------------------------------------------------------
   ...
   Idéias: Vahvel(vahve-capeta@hotmail.com)
...
$qr = odbc_exec($conexao, "SELECT * FROM CL WHERE MIconCnt =$Lider"); // Script Que Busca Informaçoes do Clan
