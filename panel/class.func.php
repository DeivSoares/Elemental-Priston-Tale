...
$cfgBadChars='`~!@#$%^&*()+-_={};\'\\:"|,/<>? ';
    ...
    function char2Name($classNum)
    {
        switch ($classNum)
        {
			...
			case "09":
                $charClassName="Assassin";
            break;
			
			case "10":
                $charClassName="Shaman";
            break;
			
			case "11":
                $charClassName="Martial";
            break;
    ...
    function charResetHair($class,$model)
    {
        switch ($class)
        {
			...
			case "Assassin":
                $modelName1=pack("a*","char\\tmABCD\\e001.ini").pack("h*",00);
                $modelName2=pack("a*","char\\tmABCD\\tfh-e02.inf").pack("h*",00);
            break;
			
			case "Shaman":
                $modelName1=pack("a*","char\\tmABCD\\me001.ini");
                $modelName2=pack("a*","char\\tmABCD\\Mmh-E02.inf").pack("h*",00);
            break;
			
			case "Martial":
                $modelName1=pack("a*","char\\tmABCD\\f001.ini").pack("h*",00);
                $modelName2=pack("a*","char\\tmABCD\\tfh-f02.inf").pack("h*",00);
            break;
