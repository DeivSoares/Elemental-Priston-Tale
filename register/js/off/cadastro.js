...
function cadastrar()
{
    ...
    $.ajax({
        ...
        data: {Combo: "cadastrar", txtLogin: txtLogin, txtSenha: txtSenha, txtNome: txtNome, txtSobrenome: txtSobrenome, txtEmail: txtEmail, txtDataNascimento: txtDataNascimento, ddlSexo: ddlSexo, txtPais: txtPais, txtEstado: txtEstado, txtCidade: txtCidade, txtPhone: txtPhone, ddlPergunta: ddlPergunta, txtResposta: txtResposta }
    })
    .done(function(msg) {
        $("#SPCadastro").html(msg);
