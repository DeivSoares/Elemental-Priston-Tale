...
function cadastrar()
{
	...
	if(txtPhone=="")
	{
		retornaCritica("Por favor, informe seu telefone.", "danger", "txtPhone");
		return false;
	}
	...
	var ddlRepres = $("#ddlRepres").val();
	if(ddlRepres=="")
	{
		retornaCritica("Por favor, informe como conheceu o jogo.", "danger", "txtRep");
		return false;
	}
	...
	$("#SPCadastro").html("<div class='alert alert-warning'>Cadastrando, aguarde...(2)</div>");
    $.ajax({
        type: "POST",
        url: "ajax_cadastro.asp",
        data: {Combo: "cadastrar", txtLogin: txtLogin, txtSenha: txtSenha, txtNome: txtNome, txtSobrenome: txtSobrenome, txtEmail: txtEmail, txtDataNascimento: txtDataNascimento, ddlSexo: ddlSexo, txtPais: txtPais, txtEstado: txtEstado, txtCidade: txtCidade, txtPhone: txtPhone, ddlPergunta: ddlPergunta, ddlRepres: ddlRepres, txtResposta: txtResposta }
    })
    .done(function(msg) {
        $("#SPCadastro").html(msg);
...
function confirmarConta()
{
	...
	$("#SPConfirmaConta").html("<div class='alert alert-warning'>Cadastrando, aguarde... (1)</div>");
    $.ajax({
        type: "POST",
        url: "ajax_cadastro.asp",
