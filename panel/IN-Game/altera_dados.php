...
<HEAD>
 ...
 <form  name="form_cad" method="post" action="index.php?sessadm=alteradados" onSubmit="return verifica2()">
...
$query22 = "INSERT INTO [accountdb].[dbo].[".( strtoupper($LOGIN[0]) ) ."GameUser]
		 (userid, Passwd, GPCode, RegistDay, DisuseDay, inuse, grade, EventChk, SelectChk, BlockChk, SpecialChk, Credit, DelChk)
		values ('$LOGIN','$SENHA', 'PTP-RUD001', getdate(), '2090-01-01',0, 0, 0, 0, 0, 0, 0, 0) ";
	$q22 = odbc_exec($connection, $query22);
	?>
	
                  <tr>
                    <td align="right"><b>COMUNICADO</b></td>
                    <td><font color="#84A30E">
					SUA CONTA ESTAVA DESATIAVADA E ACABA DE SER ATIVADA PARA LOGIN NO JOGO! </td>
                  </tr>
...
if 	($LOGINchk <> '')
{
	...
	?>
                  ...
                  <tr>
                    <td align="right"><b>COMUNICADO</b></td>
                    <td><font color="#218F18">
					SUA CONTA ESTA ATIVADA! </td>
                  </tr>
...
?>
                  ...
                  <tr>
                    ...
                    <td><input name="oldpwd" type="password" id="oldpwd" value="" size="20" maxlength="20"><br><font color="#FF0000">
					Digite sua senha para conseguir editar seus dados!  </td>
                  </tr>
                  <tr>
                 ...
                 <tr>
                    ...
                    <td>                      <input name="email" type="text" id="email" readonly value="<? echo $EMAILX; ?>" size="100" maxlength="100"> <br><font color="#FF0000">
...
<select name="sex1"  class="imput1">
 ...
 <p>
   <?
           ...
           if(!$_POST[acao2]!="Atualizar Dados")
...
echo "<center><font face=verdana size=2> Erro, caracteres não permitidos foram digitados! <br> Nãoo use UNDERLINE ( _ ) no Email ou em outro campo! <br> <a href='cadastrar.php'>Voltar e Tentar Novamente</a>";
	...
	[Phone] ='$what'
					...
					WHERE [LOGIN]='$usernameP' and senha = '$senha'";
					$q3 = odbc_exec($connection, $query3);
		...
		if($q3){
			...
			echo "<meta HTTP-EQUIV='Refresh' CONTENT='1;URL=index.php?sessadm=alteradados'>";
		}			
