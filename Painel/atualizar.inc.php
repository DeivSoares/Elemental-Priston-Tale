...
?>
    <h4 class="title text-left"><i class="pe-7s-angle-right"></i>Alterar Dados</h4>
    <hr />
...
<button type='button' aria-hidden='true' class='close'><a href='index.php?sess=mudasenha'>�</a></button>
                                    <span><b> ElementalPT - </b> Erro, caracteres n�o permitidos foram digitados!</span>";
    } else {
...
<button type='button' aria-hidden='true' class='close'><a href='index.php?sess=mudasenha'>�</a></button>
<span><b> ElementalPT - </b> $key</b> � obrigat�rio</span>";
            else
                $chkArr[] = true;
        }
...
<span><b> ElementalPT - </b> Tente Novamente!</span>";
                        ...
                        echo "<div class='alert alert-danger text-center' role='alert'>
<button type='button' aria-hidden='true' class='close'><a href='index.php?sess=mudasenha'>�</a></button>
<span><b> ElementalPT - </b> Senha Antiga est� incorreta!</span>";
                    }
                } else {
                    echo "<div class='alert alert-danger text-center' role='alert'>
<button type='button' aria-hidden='true' class='close'><a href='index.php?sess=mudasenha'>�</a></button>
