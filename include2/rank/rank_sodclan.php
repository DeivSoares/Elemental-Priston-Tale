...
<thead><tr><th>Clan</th><th>Pontos</th><th>Membros</th></tr></thead><tbody>
<?
// Configuração SQL.
...
$query = "SELECT TOP 100* FROM [ClanDB].[dbo].[CL] WHERE ClanName <> 'ShadowPK' ORDER BY Cpoint DESC";;
                    ...
                    echo  "<span class='team-meta__place'>$lider</span></div></div></td>";
					echo  "<td><h6 class='team-meta__name'>$pontos</h6></td><td><h6 class='team-meta__name'>$membros </h6></td></tr>";
					}
?>
