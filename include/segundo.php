<meta http-equiv="refresh" content="2;url=terceiro.php" />
<script>
function click() {
...
$query = "SELECT TOP 2 * FROM [ClanDB].[dbo].[CL] ORDER BY Cpoint DESC";
...
<div id="alinhamento"><img src="images/Prata.png" width="22" height="22"></div>
