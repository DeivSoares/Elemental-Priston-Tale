...
<html>
	...
	<body>
		...
		<?php 
			...
			$verifica = "SELECT TOP 100 * FROM [ClanDb].[dbo].[CL] MemCnt WHERE ClanName <> '$ClanEquipe' ORDER BY MemCnt DESC";
			echo '<table class="bbc_table" align="center" width="'.$larguraclanlist.'"><tr>
			
			<th><center>N°</center></th>
			<th width="30px"><center>Tag</center></th>
			<th><center>Clan</center></th>
			<th><center>Líder</center></th>
			<th><center>Membros</center></th>
			...
			echo '<td><center>'.$membros.'</center></td>';
			echo '</tr>';
			$i++;
			}
			echo '';
